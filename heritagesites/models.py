...
class HeritageSite(models.Model):
    ...
    def sub_region_names(self):
        ...
        for sub in sub_regions:
            try:
                name = sub.location.sub_region.sub_region_name
                if name is None:
                    continue
                if name not in names:
                    names.append(name)
    ...
    def intermediate_region_names(self):
        ...
        names = []
        for inter in intermediate_regions:
            try:
                name = inter.location.intermediate_region.intermediate_region_name
                if name is None:
                    continue
                if name not in names:
                    names.append(name)
...
class Planet(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'The Planet'
        verbose_name_plural = 'The Planets'
